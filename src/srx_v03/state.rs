//! State and Scratchpad Workspace buffers for SRXFORMER v03.
//! Provides strictly O(1) context state (160 bytes in default lang_512: 100% L1D cache resident),
...
/// Internal recurrent memory state for SRX v03 attention.
...
impl SrxState {
    ...
    pub fn new(config: &TransformerConfig) -> Self {
        ...
        // Butterfly factorization uses exactly head_dim angles (for head_dim=4, exactly 4 angles)
...
/// Pre-allocated scratchpad buffers for SRX v03 inference and forward unroll.
...
mod tests {
    ...
    fn test_srx_v03_state_size() {
        ...
        assert!(state.memory_bytes() <= 256, "SRX v03 state fits in tiny fraction of L1 Cache!");
    }
}
